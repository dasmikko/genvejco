	...
	<section class="hero is-primary is-fullheight">
			...
			<header class="nav">
				<div class="container">
					...
					<div class="nav-right nav-menu">
						<a href="/" class="nav-item @if($currentPath == "/") is-active @endif">
							Generer kortlink
						</a>
						...
						@else
							...
							<a href="{{ route('userlogin') }}" class="nav-item @if($currentPath == "login") is-active @endif">
								Log ind 
							</a>
		...
		<div class="hero-foot">
			<nav class="tabs">
				<div class="container">
					<ul>
						<li><a href="{{route('home').'/report'}}">Anmeld kortlink</a></li>
					</ul>
				</div>
			</nav>
		</div>
